...
class _PrivacyPolicyState extends State<PrivacyPolicy> {
  final String companyName = "Tomatoes";
  final String appName = "FTC Scouter";
  ...
  Widget generateTitle(String title){
    return Text(
      ...
      style: TextStyle(
        ...
        fontSize: SizeConfig.isMobilePortrait ? SizeConfig.heightMultiplier * 2.5: SizeConfig.widthMultiplier * 2.5
      ),
    );
  }
  ...
  TextSpan company(){
    return TextSpan(
      text: companyName,
      style: const TextStyle(fontStyle: FontStyle.italic, color: Colors.black, fontSize: 15)
    );
  }
        ...
        child: ListView(
          children: [
            ...
            RichText(
              text: const TextSpan(
                children: [
                  TextSpan(text: "We do not exchange your personal information with any third parties.", style: TextStyle(color: Colors.black, fontSize: 15))
                ]
              )
            ),
            Container(height: 15),
            ...
            RichText(
              text: const TextSpan(
                children: [
                  TextSpan(text: "No location information is collected or stored from any users of the app.", style: TextStyle(color: Colors.black, fontSize: 15))
                ]
              )
            ),
            Container(height: 15),
            ...
            RichText(
              text: const TextSpan(
                children: [
                  TextSpan(text: 'Cookies are files with small amount of data that is commonly used an anonymous unique identifier. These are sent to your browser from the website that you visit and are stored on your devices’s internal memory. ', style: TextStyle(color: Colors.black, fontSize: 15)),
                ]
              )
            ),
            Container(height: 15,),
